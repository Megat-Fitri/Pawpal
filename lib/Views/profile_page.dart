...
class _ProfilePageState extends State<ProfilePage> {
  ...
  bool isEditing = false; // New variable to track editing state
  ...
  void _loadUserData() {
    ...
    nameEmailController.text = widget.user.userEmail ?? '';
  ...
  Future<void> _updateProfile() async {
    ...
    final response = await http.post(
      Uri.parse('${MyConfig.baseUrl}/api/pawpal/submit_profile.php'),
      body: {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        CircleAvatar(
                          radius: 40,
                          backgroundColor:  const Color.fromARGB(255, 253, 95, 148),
                          child: Text(
            ...
            return AlertDialog(
              ...
              title: Row(
                children: const [
                  Icon(
                    Icons.account_balance_wallet_outlined,
                    color: Color.fromARGB(255, 221, 177, 158),
                  ),
                  SizedBox(width: 8),
                  Text("Buy Credits"),
                ],
  ...
  void loadProfile() {
    http
        .get(
          Uri.parse(
            '${MyConfig.baseUrl}/api/pawpal/getuserdetails.php?userid=${widget.user.userId}',
          ),
        )
        .then((response) {
          if (response.statusCode == 200) {
